...
public class Account implements Serializable {
	...
	public Account(int accountId, String accountNum, String accountType, BigDecimal balance, String activeFlag,
			int customerId, String accountCreatedDatetime) {
		super();
		this.accountId = accountId;
